export default {
  ...
  'pages.role.permissions.CONFIG_ADD': 'Add Config',
  'pages.role.permissions.CONFIG_EDIT': 'Edit Config',
  'pages.role.permissions.CONFIG_DELETE': 'Delete Config',
  'pages.role.permissions.CONFIG_PUBLISH': 'Publish Config',
  'pages.role.permissions.CONFIG_OFFLINE': 'Offline Config',
  'pages.role.permissions.NODE_ADD': 'Add Node',
  'pages.role.permissions.NODE_DELETE': 'Delete Node',
  'pages.role.permissions.CLIENT_DISCONNECT': 'Disconnect Client',
  'pages.role.permissions.USER_ADD': 'Add User',
  'pages.role.permissions.USER_EDIT': 'Edit User',
  'pages.role.permissions.USER_DELETE': 'Delete User',
