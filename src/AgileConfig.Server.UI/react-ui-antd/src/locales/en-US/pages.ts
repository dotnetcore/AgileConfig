export default {
  ...
  'pages.user.table.cols.usertype': 'Type',
  ...
  'pages.user.form.usertype': 'Type',
  'pages.user.form.status': 'Status',
  'pages.user.usertype.normaluser': 'Operator',
  'pages.user.usertype.admin': 'Administrator',
  'pages.user.usertype.superadmin': 'Super Administrator',
  ...
  'pages.role.table.cols.code': 'Code',
