export default {
  ...
  'pages.user.form.usertype': '类型',
  'pages.user.form.status': '状态',
  'pages.user.usertype.normaluser': '操作员',
  'pages.user.usertype.admin': '管理员',
  'pages.user.usertype.superadmin': '超级管理员',
