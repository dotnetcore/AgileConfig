...
public class Startup
{
    ...
    private static bool IsTrustSSL(IConfiguration configuration)
    {
        ...
        if (!string.IsNullOrEmpty(alwaysTrustSsl) && alwaysTrustSsl.ToLower() == "true") return true;
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        if (Appsettings.IsPreviewMode) AddSwaggerService(services);
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider)
    {
        ...
        if (Appsettings.IsPreviewMode) AddSwaggerMiddleWare(app);
