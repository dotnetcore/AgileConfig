...
(function (l) {
	var E = function () {
		...
		v.recursiveClone = function (g) {
			if (!g || typeof g != "object" || g instanceof RegExp || !Array.isArray(g) && Object.getPrototypeOf(g) !== Object.prototype)
				return g;
		...
		v.getHighPerformanceTimestamp = function () {
			return this.PERFORMANCE_NOW_PROBED || (this.PERFORMANCE_NOW_PROBED = !0, this.HAS_PERFORMANCE_NOW = l.global.performance && typeof l.global.performance.now == "function"),
...
(function (l) {
	function E(a) {
		...
		return a.stack && (n.stack = a.stack),
		n
	}
	l.ensureError = E;
	var v = function () {
	...
	var g = function () {
		...
		a.prototype._createSortedPathsRules = function () {
			...
			l.Utilities.forEachProperty(this.options.paths, function (_, s) {
				Array.isArray(s) ? n.sortedPathsRules.push({
					from: _,
					to: s
		...
		a.prototype._applyPaths = function (n) {
			for (var _, s = 0, e = this.sortedPathsRules.length; s < e; s++)
				if (_ = this.sortedPathsRules[s], l.Utilities.startsWith(n, _.from)) {
		...
		a.prototype.moduleIdToPaths = function (n) {
			if (this._env.isNode) {
				...
				if (_)
					return this.isBuild() ? ["empty:"] : ["node|" + n]
			}
			var s = n,
			e;
			if (!l.Utilities.endsWith(s, ".js") && !l.Utilities.isAbsolutePath(s)) {
				...
				for (var t = 0, r = e.length; t < r; t++)
					this.isBuild() && e[t] === "empty:" || (l.Utilities.isAbsolutePath(e[t]) || (e[t] = this.options.baseUrl + e[t]), !l.Utilities.endsWith(e[t], ".js") && !l.Utilities.containsQueryString(e[t]) && (e[t] = e[t] + ".js"))
		...
		a.prototype.requireToUrl = function (n) {
			var _ = n;
			return l.Utilities.isAbsolutePath(_) || (_ = this._applyPaths(_)[0], l.Utilities.isAbsolutePath(_) || (_ = this.options.baseUrl + _)),
...
(function (l) {
		...
		return e.prototype.load = function (t, r, i, o) {
			...
			if (!this._scriptLoader)
				if (this._env.isWebWorker)
					...
					this._env.isNode ? this._scriptLoader = new n(this._env) : this._scriptLoader = new v;
			var f = {
				callback: i,
				errorback: o
			};
			...
			this._scriptLoader.load(t, r, function () {
	...
	var a = function () {
		...
		return e.prototype._canUseEval = function (t) {
			return this._cachedCanUseEval === null && (this._cachedCanUseEval = g(t)),
	...
	n = function () {
		...
		e.prototype._initNodeRequire = function (t, r) {
			...
			u.prototype._compile = function (f, p) {
				...
				U = o._path.dirname(p),
				w = c(this),
				O = [this.exports, w, this, p, U, process, _commonjsGlobal, Buffer],
				C = R.apply(this.exports, O);
				return o._handleCachedData(b, d, h, !m.cachedData, r),
		...
		e.prototype.load = function (t, r, i, o) {
			...
			p = c.nodeInstrumenter || function (R) {
				return R
			};
			this._init(f),
			this._initNodeRequire(f, t);
			var d = t.getRecorder();
			if (/^node\|/.test(r)) {
				var y = r.split("|"),
				h = null;
				...
				this._readSourceAndCachedData(m, b, d, function (R, U, w, O) {
					...
					var C;
					U.charCodeAt(0) === e._BOM ? C = e._PREFIX + U.substring(1) + e._SUFFIX : C = e._PREFIX + U + e._SUFFIX,
					C = p(C, m);
					var M = {
						filename: P,
						cachedData: w
		...
		e.prototype._createAndEvalScript = function (t, r, i, o, u) {
			...
			return h.amd = d.amd,
			p.call(l.global, t.getGlobalAMDRequireFunc(), h, i.filename, this._path.dirname(i.filename)),
			c.record(32, i.filename),
			y ? o() : u(new Error("Didn't receive define call in " + i.filename + "!")),
			f
		},
		...
		e.prototype._readSourceAndCachedData = function (t, r, i, o) {
			if (!r)
				...
				this._fs.readFile(r, function (y, h) {
					!y && h && h.length > 0 ? (f = h.slice(0, 16), c = h.slice(16), i.record(60, r)) : i.record(61, r),
					d()
				})
			}
		},
...
(function (l) {
	var E = function () {
		...
		s.prototype.resolveModule = function (e) {
			var t = e;
			return l.Utilities.isAbsolutePath(t) || (l.Utilities.startsWith(t, "./") || l.Utilities.startsWith(t, "../")) && (t = s._normalizeModuleId(this.fromModulePath + t)),
			t
		},
		s.ROOT = new s(""),
		s
		...
		s.prototype.complete = function (e, t, r) {
			...
			if (this._callback)
				if (typeof this._callback == "function") {
					...
					!i && typeof o.returnedValue != "undefined" && (!this.exportsPassedIn || l.Utilities.isEmpty(this.exports)) && (this.exports = o.returnedValue)
				} else
	...
	var g = function () {
		...
		s.prototype.getModuleId = function (e) {
			...
			return typeof t == "undefined" && (t = this._nextId++, this._strModuleIdToIntModuleId.set(e, t), this._intModuleIdToStrModuleId[t] = e),
			t
		},
	...
	var _ = function () {
			...
			for (var r = function (m) {
				...
				if (c) {
					...
					if (f = f.substr(y), f = r(f), f === i) {
						...
						return h.line === 1 && (h.col -= "(function (require, define, __filename, __dirname) { ".length),
						h
					}
				}
			}
		...
		s.prototype.defineModule = function (e, t, r, i, o, u) {
			...
			this._modules2[f] = p,
			this._config.isBuild() && (this._buildInfoDefineStack[f] = o, this._buildInfoDependencies[f] = (p.dependencies || []).map(function (d) {
		...
		s.prototype._onLoadError = function (e, t) {
			...
			this._modules2[e] || (this._modules2[e] = new v(e, this._moduleIdProvider.getStrModuleId(e), [], function () {}, null, null));
			for (var i = [], o = 0, u = this._moduleIdProvider.getMaxModuleId(); o < u; o++)
				i[o] = !1;
			var c = !1,
			f = [];
			...
			if (!(this._modules2[e] || this._knownModules2[e])) {
				...
				c = function (f) {
					if (u++, u >= i.length)
						...
						d.record(10, p),
						t._scriptLoader.load(t, p, function () {
...
(function (l) {
	...
	g = function (s, e, t) {
		...
		s ? v.defineModule(s, e, t, null, null) : v.enqueueDefineAnonymousModule(e, t)
	};
	g.amd = {
		jQuery: !0
	};
	...
	l.init = _,
	(typeof l.global.define != "function" || !l.global.define.amd) && (v = new l.ModuleManager(E, l.createScriptLoader(E), g, n, l.Utilities.getHighPerformanceTimestamp()), typeof l.global.require != "undefined" && typeof l.global.require != "function" && n.config(l.global.require), define = function () {
