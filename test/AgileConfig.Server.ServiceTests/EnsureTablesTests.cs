...
public class EnsureTablesTests
{
    ...
    {
        //sqlite
        var conn = "Data Source=agile_config.db";
    ...
    {
        //SqlServer
        var conn = "Database=agile_config_test;Data Source=192.168.0.125;User Id=root;Password=x;port=13306";
    ...
    {
        //SqlServer
        var conn = "user id=CLINIC;password=CLINIC;data source=192.168.0.91/orcl";
    ...
    {
        //SqlServer
        var conn = "Host=192.168.0.125;Port=15432;Database=agileconfig;Username=postgres;Password=123456";
